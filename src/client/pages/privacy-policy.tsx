...
export default function PrivacyPolicy() {
    ...
    return (
      <TrackingProvider>
        <Head>
          <title>Privacy Policy | WorldView Insights</title>
          <meta
            name="description"
            content="WorldView Insights Privacy Policy"
          />
        </Head>
        <div className={inter.className}>
          ...
          <div className={styles["privacy-policy-content"]}>
            ...
            <div>
              ...
              <ul>
                ...
                <li>
                  <p>
                    ...
                    Company&quot;, &quot;We&quot;, &quot;Us&quot; or
                    &quot;Our&quot; in this Agreement) refers to WorldView
                    Industries LLC, 382 Cherry Street, Unit 308, Chattanooga, TN
                    37403.
                  </p>
                </li>
                <li>
                ...
                <li>
                  <p>
                    <strong>Website</strong> refers to WorldView Insights,
                    accessible from{" "}
                    <a
                      href="https://worldviewinsights.com"
              ...
              <ul>
                <li>
                  <p>By email: contact.worldviewinsights@gmail.com</p>
                </li>
                <li>
                  <p>
                    By visiting this page on our website:{" "}
                    <a
                      href="https://worldviewinsights.com/contact"
                      rel="external nofollow noopener"
                      target="_blank"
                    >
                      https://worldviewinsights.com/contact
                    </a>
                  </p>
                </li>
              </ul>
