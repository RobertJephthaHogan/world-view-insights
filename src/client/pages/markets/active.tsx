...
import styles from '../../styles/pages/markets/active.module.css'
...
export default function ActiveStocks() {
    ...
    useEffect(() => {
        ...
        //if tableType === 'price', get table data from /data/most_active_table
        if (tableType === 'price') {
        ...
        //TODO: if tableType === 'performance', get table data from /data/most_active_performance_table

        //TODO: if tableType === 'technical', get table data from /data/most_active_technicals_table

        //TODO: if tableType === 'fundamental', get table data from /data/most_active_fundamentals_table
    ...
    return (
        <TrackingProvider>
            ...
            <div className={inter.className}>
                <Header/>
                <div className={styles['active-component']}>
                    ...
                    <div className={styles['lc-center']}>
                        <div>
                            <div className={styles['tlt-container']}>
                                <span className={styles['top-active-title']}>
                                    Most Active - United Stated Stocks
                                </span>
                            </div>
                            <div className={styles['tl-divider']}/>
                            <div className={styles['tld-container']}>
                                <span>
                                    Explore the market movers and most active stocks
                                    in the US stock market, capturing notable activity 
