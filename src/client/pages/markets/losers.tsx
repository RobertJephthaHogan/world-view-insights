...
import styles from '../../styles/pages/markets/losers.module.css'
...
export default function Losers() {
    ...
    useEffect(() => {
        ...
        //TODO: if tableType === 'performance', get table data from /data/losers_performance_table

        //TODO: if tableType === 'technical', get table data from /data/losers_technicals_table

        //TODO: if tableType === 'fundamental', get table data from /data/losers_fundamentals_table
    ...
    return (
        <TrackingProvider>
            ...
            <div className={inter.className}>
                <Header/>
                <div className={styles['losers-component']}>
                    ...
                    <div className={styles['lc-center']}>
                        <div>
                            <div className={styles['tlt-container']}>
                                <span className={styles['top-losers-title']}>
                                    Top Losers - United Stated Stocks
                                </span>
                            </div>
                            <div className={styles['tl-divider']}/>
                            <div className={styles['tld-container']}>
                                <span>
                                    Explore the market movers and top stock losers 
