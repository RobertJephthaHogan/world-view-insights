...
class OpenAiController:
    ...
    # Write Competitor Article (Comment out in prod, security++ :3)
    ...
    @router.get("/write_competitor_article_title/")
    async def write_competitor_article_title():
        test_title = 'Adobe Plunges 14% on Weak Outlook'
        data = await OpenAiService.write_competitor_article_title(test_title)
        return data